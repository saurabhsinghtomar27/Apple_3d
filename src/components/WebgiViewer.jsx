...
const WebgiViewer = forwardRef((props, ref) => {
  ...
  const memorizedScrollAnimation = useCallback((position, target, isMobile, update) => {
    if (position && target && update)
      scrollAnimation(position, target, isMobile, update)
  }, [])
  ...
  }, [canvasContainerRef, viewerRef, positionRef, targetRef, cameraRef, targetRef])

  return (
    <div ref={canvasContainerRef} id="webgi-canvas-container">
      <canvas ref={CanvasRef} id="webgi-canvas" width="800"></canvas>
      {
        previewMode && (
